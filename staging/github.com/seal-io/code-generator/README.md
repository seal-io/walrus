...
Extend [k8s.io/code-generator](https://github.com/kubernetes/code-generator) to support the following:

- [CRD Gen](./cmd/crd-gen): Code generators for the CRD (Custom Resource Definition) API.
