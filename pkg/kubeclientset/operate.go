...
// WithStatusOnly patches the status if the resource exists.
...
//
// Apply only patched the status if WithStatusOnly provided.
...
//
// ApplyWithCtrlClient doesn't support WithStatusOnly.
