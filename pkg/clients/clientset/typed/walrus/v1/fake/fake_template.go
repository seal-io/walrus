...
func (c *FakeTemplates) Apply(ctx context.Context, template *walrusv1.TemplateApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Template, err error) {
	if template == nil {
...
func (c *FakeTemplates) ApplyStatus(ctx context.Context, template *walrusv1.TemplateApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Template, err error) {
	if template == nil {
		return nil, fmt.Errorf("template provided to Apply must not be nil")
	}
	data, err := json.Marshal(template)
