...
func (c *FakeEnvironments) Apply(ctx context.Context, environment *walrusv1.EnvironmentApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Environment, err error) {
	if environment == nil {
