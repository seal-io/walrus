...
func (c *FakeCatalogs) Apply(ctx context.Context, catalog *walrusv1.CatalogApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Catalog, err error) {
	if catalog == nil {
...
func (c *FakeCatalogs) ApplyStatus(ctx context.Context, catalog *walrusv1.CatalogApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Catalog, err error) {
	if catalog == nil {
		return nil, fmt.Errorf("catalog provided to Apply must not be nil")
	}
	data, err := json.Marshal(catalog)
