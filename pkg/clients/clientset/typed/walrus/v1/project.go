...
type ProjectInterface interface {
	...
	Apply(ctx context.Context, project *walrusv1.ProjectApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Project, err error)
	GetSubjects(ctx context.Context, projectName string, options metav1.GetOptions) (*v1.ProjectSubjects, error)
	UpdateSubjects(ctx context.Context, projectName string, projectSubjects *v1.ProjectSubjects, opts metav1.UpdateOptions) (*v1.ProjectSubjects, error)
	PatchSubjects(ctx context.Context, projectName string, projectSubjects *v1.ProjectSubjects, opts metav1.UpdateOptions) (*v1.ProjectSubjects, error)
...
func newProjects(c *WalrusV1Client, namespace string) *projects {
	return &projects{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *projects) Apply(ctx context.Context, project *walrusv1.ProjectApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Project, err error) {
	if project == nil {
...
// GetSubjects takes name of the project, and returns the corresponding v1.ProjectSubjects object, and an error if there is any.
func (c *projects) GetSubjects(ctx context.Context, projectName string, options metav1.GetOptions) (result *v1.ProjectSubjects, err error) {
	result = &v1.ProjectSubjects{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("projects").
		Name(projectName).
...
// UpdateSubjects takes the top resource name and the representation of a projectSubjects and updates it. Returns the server's representation of the projectSubjects, and an error, if there is any.
func (c *projects) UpdateSubjects(ctx context.Context, projectName string, projectSubjects *v1.ProjectSubjects, opts metav1.UpdateOptions) (result *v1.ProjectSubjects, err error) {
	result = &v1.ProjectSubjects{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projects").
		...
		SubResource("subjects").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(projectSubjects).
		Do(ctx).
		Into(result)
	return
}

// PatchSubjects takes the top resource name and the representation of a projectSubjects and updates it. Returns the server's representation of the projectSubjects, and an error, if there is any.
func (c *projects) PatchSubjects(ctx context.Context, projectName string, projectSubjects *v1.ProjectSubjects, opts metav1.UpdateOptions) (result *v1.ProjectSubjects, err error) {
	result = &v1.ProjectSubjects{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("projects").
