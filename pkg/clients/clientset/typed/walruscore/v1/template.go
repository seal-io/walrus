...
type TemplateInterface interface {
	...
	Apply(ctx context.Context, template *walruscorev1.TemplateApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Template, err error)
	ApplyStatus(ctx context.Context, template *walruscorev1.TemplateApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Template, err error)
	TemplateExpansion
}
...
func newTemplates(c *WalruscoreV1Client, namespace string) *templates {
	return &templates{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *templates) Apply(ctx context.Context, template *walruscorev1.TemplateApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Template, err error) {
	if template == nil {
...
func (c *templates) ApplyStatus(ctx context.Context, template *walruscorev1.TemplateApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Template, err error) {
	if template == nil {
		return nil, fmt.Errorf("template provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
