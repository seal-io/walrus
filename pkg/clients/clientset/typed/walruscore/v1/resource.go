...
type ResourceInterface interface {
	...
	Apply(ctx context.Context, resource *walruscorev1.ResourceApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Resource, err error)
	ApplyStatus(ctx context.Context, resource *walruscorev1.ResourceApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Resource, err error)
	ResourceExpansion
}
...
func newResources(c *WalruscoreV1Client, namespace string) *resources {
	return &resources{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *resources) Apply(ctx context.Context, resource *walruscorev1.ResourceApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Resource, err error) {
	if resource == nil {
...
func (c *resources) ApplyStatus(ctx context.Context, resource *walruscorev1.ResourceApplyConfiguration, opts metav1.ApplyOptions) (result *v1.Resource, err error) {
	if resource == nil {
		return nil, fmt.Errorf("resource provided to Apply must not be nil")
	}
	patchOpts := opts.ToPatchOptions()
