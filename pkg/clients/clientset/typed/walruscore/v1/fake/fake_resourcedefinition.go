...
func (c *FakeResourceDefinitions) Apply(ctx context.Context, resourceDefinition *walruscorev1.ResourceDefinitionApplyConfiguration, opts metav1.ApplyOptions) (result *v1.ResourceDefinition, err error) {
...
func (c *FakeResourceDefinitions) ApplyStatus(ctx context.Context, resourceDefinition *walruscorev1.ResourceDefinitionApplyConfiguration, opts metav1.ApplyOptions) (result *v1.ResourceDefinition, err error) {
	if resourceDefinition == nil {
		return nil, fmt.Errorf("resourceDefinition provided to Apply must not be nil")
	}
	data, err := json.Marshal(resourceDefinition)
