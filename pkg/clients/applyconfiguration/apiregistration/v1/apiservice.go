...
// APIServiceApplyConfiguration represents an declarative configuration of the APIService type for use
// with apply.
...
// APIService constructs an declarative configuration of the APIService type for use with
// apply.
