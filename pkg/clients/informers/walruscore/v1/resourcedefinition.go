	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.WalruscoreV1().ResourceDefinitions(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WalruscoreV1().ResourceDefinitions(namespace).Watch(context.TODO(), options)
			},
		},
		&walruscorev1.ResourceDefinition{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *resourceDefinitionInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&walruscorev1.ResourceDefinition{}, f.defaultInformer)
}
