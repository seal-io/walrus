	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.WalruscoreV1().Catalogs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WalruscoreV1().Catalogs(namespace).Watch(context.TODO(), options)
			},
		},
		&walruscorev1.Catalog{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *catalogInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&walruscorev1.Catalog{}, f.defaultInformer)
}
