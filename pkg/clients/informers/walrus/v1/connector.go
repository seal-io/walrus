	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.WalrusV1().Connectors(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.WalrusV1().Connectors(namespace).Watch(context.TODO(), options)
			},
		},
		&walrusv1.Connector{},
		resyncPeriod,
...
func (f *connectorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&walrusv1.Connector{}, f.defaultInformer)
}
