...
func ProjectID(v oid.ID) predicate.ApplicationResource {
	return predicate.ApplicationResource(sql.FieldEQ(FieldProjectID, v))
}
...
func ProjectIDEQ(v oid.ID) predicate.ApplicationResource {
	return predicate.ApplicationResource(sql.FieldEQ(FieldProjectID, v))
}

// ProjectIDNEQ applies the NEQ predicate on the "projectID" field.
func ProjectIDNEQ(v oid.ID) predicate.ApplicationResource {
	return predicate.ApplicationResource(sql.FieldNEQ(FieldProjectID, v))
}

// ProjectIDIn applies the In predicate on the "projectID" field.
func ProjectIDIn(vs ...oid.ID) predicate.ApplicationResource {
	return predicate.ApplicationResource(sql.FieldIn(FieldProjectID, vs...))
}

// ProjectIDNotIn applies the NotIn predicate on the "projectID" field.
func ProjectIDNotIn(vs ...oid.ID) predicate.ApplicationResource {
	return predicate.ApplicationResource(sql.FieldNotIn(FieldProjectID, vs...))
}

// ProjectIDGT applies the GT predicate on the "projectID" field.
func ProjectIDGT(v oid.ID) predicate.ApplicationResource {
	return predicate.ApplicationResource(sql.FieldGT(FieldProjectID, v))
}

// ProjectIDGTE applies the GTE predicate on the "projectID" field.
func ProjectIDGTE(v oid.ID) predicate.ApplicationResource {
	return predicate.ApplicationResource(sql.FieldGTE(FieldProjectID, v))
}

// ProjectIDLT applies the LT predicate on the "projectID" field.
func ProjectIDLT(v oid.ID) predicate.ApplicationResource {
	return predicate.ApplicationResource(sql.FieldLT(FieldProjectID, v))
}

// ProjectIDLTE applies the LTE predicate on the "projectID" field.
func ProjectIDLTE(v oid.ID) predicate.ApplicationResource {
	return predicate.ApplicationResource(sql.FieldLTE(FieldProjectID, v))
}

// ProjectIDContains applies the Contains predicate on the "projectID" field.
func ProjectIDContains(v oid.ID) predicate.ApplicationResource {
	vc := string(v)
	return predicate.ApplicationResource(sql.FieldContains(FieldProjectID, vc))
}

// ProjectIDHasPrefix applies the HasPrefix predicate on the "projectID" field.
func ProjectIDHasPrefix(v oid.ID) predicate.ApplicationResource {
	vc := string(v)
	return predicate.ApplicationResource(sql.FieldHasPrefix(FieldProjectID, vc))
}

// ProjectIDHasSuffix applies the HasSuffix predicate on the "projectID" field.
func ProjectIDHasSuffix(v oid.ID) predicate.ApplicationResource {
	vc := string(v)
	return predicate.ApplicationResource(sql.FieldHasSuffix(FieldProjectID, vc))
}

// ProjectIDEqualFold applies the EqualFold predicate on the "projectID" field.
func ProjectIDEqualFold(v oid.ID) predicate.ApplicationResource {
	vc := string(v)
	return predicate.ApplicationResource(sql.FieldEqualFold(FieldProjectID, vc))
}

// ProjectIDContainsFold applies the ContainsFold predicate on the "projectID" field.
func ProjectIDContainsFold(v oid.ID) predicate.ApplicationResource {
	vc := string(v)
	return predicate.ApplicationResource(sql.FieldContainsFold(FieldProjectID, vc))
}
