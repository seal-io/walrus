...
func (srru *SubjectRoleRelationshipUpdate) Save(ctx context.Context) (int, error) {
	return withHooks[int, SubjectRoleRelationshipMutation](ctx, srru.sqlSave, srru.mutation, srru.hooks)
}
...
func (srruo *SubjectRoleRelationshipUpdateOne) Save(ctx context.Context) (*SubjectRoleRelationship, error) {
	return withHooks[*SubjectRoleRelationship, SubjectRoleRelationshipMutation](ctx, srruo.sqlSave, srruo.mutation, srruo.hooks)
}
