...
func (ecru *EnvironmentConnectorRelationshipUpdate) Save(ctx context.Context) (int, error) {
	return withHooks(ctx, ecru.sqlSave, ecru.mutation, ecru.hooks)
}
...
func (ecru *EnvironmentConnectorRelationshipUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	_spec := sqlgraph.NewUpdateSpec(environmentconnectorrelationship.Table, environmentconnectorrelationship.Columns, sqlgraph.NewFieldSpec(environmentconnectorrelationship.FieldID, field.TypeString))
...
func (ecruo *EnvironmentConnectorRelationshipUpdateOne) Save(ctx context.Context) (*EnvironmentConnectorRelationship, error) {
	return withHooks(ctx, ecruo.sqlSave, ecruo.mutation, ecruo.hooks)
}
