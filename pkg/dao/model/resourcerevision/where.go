...
func And(predicates ...predicate.ResourceRevision) predicate.ResourceRevision {
	return predicate.ResourceRevision(sql.AndPredicates(predicates...))
}

// Or groups predicates with the OR operator between them.
func Or(predicates ...predicate.ResourceRevision) predicate.ResourceRevision {
	return predicate.ResourceRevision(sql.OrPredicates(predicates...))
}

// Not applies the not operator on the given predicate.
func Not(p predicate.ResourceRevision) predicate.ResourceRevision {
	return predicate.ResourceRevision(sql.NotPredicates(p))
}
