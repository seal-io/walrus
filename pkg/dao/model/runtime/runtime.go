...
func init() {
	...
	// servicerelationshipDescCreateTime is the schema descriptor for createTime field.
	servicerelationshipDescCreateTime := servicerelationshipMixinFields1[0].Descriptor()
	// servicerelationship.DefaultCreateTime holds the default value on creation for the createTime field.
	...
	servicerevisionDescTemplateID := servicerevisionFields[3].Descriptor()
