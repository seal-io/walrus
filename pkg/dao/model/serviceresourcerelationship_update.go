...
func (srru *ServiceResourceRelationshipUpdate) Save(ctx context.Context) (int, error) {
	return withHooks[int, ServiceResourceRelationshipMutation](ctx, srru.sqlSave, srru.mutation, srru.hooks)
}
...
func (srruo *ServiceResourceRelationshipUpdateOne) Save(ctx context.Context) (*ServiceResourceRelationship, error) {
	return withHooks[*ServiceResourceRelationship, ServiceResourceRelationshipMutation](ctx, srruo.sqlSave, srruo.mutation, srruo.hooks)
}
