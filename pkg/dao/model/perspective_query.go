...
func (pq *PerspectiveQuery) FirstID(ctx context.Context) (id types.ID, err error) {
	var ids []types.ID
...
func (pq *PerspectiveQuery) FirstIDX(ctx context.Context) types.ID {
...
func (pq *PerspectiveQuery) OnlyID(ctx context.Context) (id types.ID, err error) {
	var ids []types.ID
...
func (pq *PerspectiveQuery) OnlyIDX(ctx context.Context) types.ID {
...
func (pq *PerspectiveQuery) IDs(ctx context.Context) (ids []types.ID, err error) {
...
func (pq *PerspectiveQuery) IDsX(ctx context.Context) []types.ID {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
