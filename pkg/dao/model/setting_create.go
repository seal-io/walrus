...
func (sc *SettingCreate) SetID(t types.ID) *SettingCreate {
	sc.mutation.SetID(t)
	return sc
}
...
func (u *SettingUpsertOne) ID(ctx context.Context) (id types.ID, err error) {
...
func (u *SettingUpsertOne) IDX(ctx context.Context) types.ID {
	id, err := u.ID(ctx)
	if err != nil {
		panic(err)
	}
