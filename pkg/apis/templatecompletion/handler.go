...
import (
	...
	"github.com/seal-io/seal/pkg/apis/templatecompletion/view"
...
var examples = []view.TemplateCompletionPromptExample{
	{
...
func (h Handler) CollectionRouteExamples(c *gin.Context, _ view.ExampleRequest) (view.ExampleResponse, error) {
	translated := make([]view.TemplateCompletionPromptExample, 0, len(examples))
	for _, e := range examples {
		translated = append(translated, view.TemplateCompletionPromptExample{
