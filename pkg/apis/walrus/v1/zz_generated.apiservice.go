...
var _ rest.Scoper = (*TemplateCompletion)(nil)

func (*TemplateCompletion) NamespaceScoped() bool {
	return true
}

var _ rest.KindProvider = (*TemplateCompletion)(nil)

func (*TemplateCompletion) Kind() string {
	return "TemplateCompletion"
}

var _ rest.SingularNameProvider = (*TemplateCompletion)(nil)

func (*TemplateCompletion) GetSingularName() string {
	return "templatecompletion"
}

var _ rest.ShortNamesProvider = (*TemplateCompletion)(nil)

func (*TemplateCompletion) ShortNames() []string {
	return []string{}
}

var _ rest.CategoriesProvider = (*TemplateCompletion)(nil)

func (*TemplateCompletion) Categories() []string {
	return []string{
		"walrus",
	}
}

var _ rest.Scoper = (*TemplateCompletionExample)(nil)

func (*TemplateCompletionExample) NamespaceScoped() bool {
	return true
}

var _ rest.KindProvider = (*TemplateCompletionExample)(nil)

func (*TemplateCompletionExample) Kind() string {
	return "TemplateCompletionExample"
}

var _ rest.SingularNameProvider = (*TemplateCompletionExample)(nil)

func (*TemplateCompletionExample) GetSingularName() string {
	return "templatecompletionexample"
}

var _ rest.ShortNamesProvider = (*TemplateCompletionExample)(nil)

func (*TemplateCompletionExample) ShortNames() []string {
	return []string{}
}

var _ rest.CategoriesProvider = (*TemplateCompletionExample)(nil)

func (*TemplateCompletionExample) Categories() []string {
	return []string{
		"walrus",
	}
}
