...
var (
	...
	cliIgnorePaths = []string{
		...
		"/projects/:project/environments/:environment/resources/:resource/components/:resourcecomponent/log",
		"/projects/:project/environments/:environment/resources/:resource/components/:resourcecomponent/exec",
		"/projects/:project/environments/:environment/resources/_/graph",
